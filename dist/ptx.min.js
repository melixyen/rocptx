...
function i(e){var i=[],a=[];return e.forEach(function(e){e.Timetables.forEach(function(n){if(-1==a.indexOf(n)){a.push(n);var t={RouteID:e.RouteID,To:e.To,Time:n,tt_sortTime:d.transTime2Sec(n,!0)};e.TrainType&&(t.TrainType=e.TrainType),i.push(t)}})}),i.sort(c.sortByTTSortTime),a=i.map(function(e){return e.Time}),{Route:e,Full:i,Simple:a,isEmpty:0==e.length}}var a=1<arguments.length&&void 0!==arguments[1]?arguments[1]:2;//運用 TimeSimple Format 計算一個車站每週每日往兩方向的所有班次資訊 , w for weekdays
