var pData = {
    ...
    trtc: {
        station_ary: [
            ...
            { id: "trtc_r22a", StationID: ["R22A"], name: "新北投", estring: "xinbeitou" },
            ...
            { id: "trtc_g03a", StationID: ["G03A"], name: "小碧潭", estring: "xiaobitan" },
    ...
    tymc: {
        ...
        station_ary: [
            //Airport Line
            { id: "tymc_a01", StationID: ["A1"], name: "臺北車站", estring: "taipeichezhantaipeimainstation", sect: 'taipei', big: 'd' },
            { id: "tymc_a02", StationID: ["A2"], name: "三重", estring: "sanchong", sect: 'taipei' },
            { id: "tymc_a03", StationID: ["A3"], name: "新北產業園區", estring: "xinbeichanyeyuanqui", sect: 'taipei', big: 'd' },
            { id: "tymc_a04", StationID: ["A4"], name: "新莊副都心", estring: "xinzhungfuduxin", sect: 'taipei' },
            { id: "tymc_a05", StationID: ["A5"], name: "泰山", estring: "taishan", sect: 'taipei' },
            { id: "tymc_a06", StationID: ["A6"], name: "泰山貴和", estring: "taishanguehe", sect: 'taipei' },
            { id: "tymc_a07", StationID: ["A7"], name: "體育大學", estring: "tiyvdaxue", sect: 'taipei' },
            { id: "tymc_a08", StationID: ["A8"], name: "長庚醫院", estring: "changgengyiyuan", sect: 'taoyuan', big: 'd' },
            { id: "tymc_a09", StationID: ["A9"], name: "林口", estring: "linkou", sect: 'taoyuan' },
            { id: "tymc_a10", StationID: ["A10"], name: "山鼻", estring: "shanbi", sect: 'taoyuan' },
            { id: "tymc_a11", StationID: ["A11"], name: "坑口", estring: "kengkou", sect: 'taoyuan' },
            { id: "tymc_a12", StationID: ["A12"], name: "機場第一航廈", estring: "terminal1", sect: 'taoyuan', big: 'd' },
            { id: "tymc_a13", StationID: ["A13"], name: "機場第二航廈", estring: "terminal2", sect: 'taoyuan', big: 'd' },
            { id: "tymc_a14a", StationID: ["A14a"], name: "機場旅館", estring: "airporthotel", sect: 'taoyuan' },
            { id: "tymc_a15", StationID: ["A15"], name: "大園", estring: "dayuan", sect: 'taoyuan' },
            { id: "tymc_a16", StationID: ["A16"], name: "橫山", estring: "hengshan", sect: 'taoyuan' },
            { id: "tymc_a17", StationID: ["A17"], name: "領航", estring: "linghang", sect: 'taoyuan' },
            { id: "tymc_a18", StationID: ["A18"], name: "高鐵桃園站", estring: "gaotietaoyuanzhan", sect: 'taoyuan' },
            { id: "tymc_a19", StationID: ["A19"], name: "桃園體育園區", estring: "taoyuantiyuyuanqui", sect: 'taoyuan' },
            { id: "tymc_a20", StationID: ["A20"], name: "興南", estring: "xingnan", sect: 'taoyuan' },
            { id: "tymc_a21", StationID: ["A21"], name: "環北", estring: "huanbei", sect: 'taoyuan' },
            { id: "tymc_a22", StationID: ["A22"], name: "老街溪", estring: "laojieriverstation", sect: 'taoyuan' }
        ],
        line: [
            {
                id: "tymc_1",
    ...
    krtc: {
        ...
        station_ary: [
            ...
            { id: "krtc_rk1", StationID: ["RK1"], name: "岡山車站", estring: "gangshanstation", sect: 'kaohsiung' },
    ...
    tmrt: {
        ...
        station_ary: [
            //G Line
            { id: "tmrt_103a", StationID: ["G0"], name: "北屯總站", estring: "beitunmainstationbeitunzhongzhan", sect: 'taichung' },
            { id: "tmrt_103", StationID: ["G3"], name: "舊社", estring: "jiushe", sect: 'taichung' },
            { id: "tmrt_104", StationID: ["G4"], name: "松竹", estring: "songzhu", sect: 'taichung' },
            { id: "tmrt_105", StationID: ["G5"], name: "四維國小", estring: "sihweielementaryschoolsiweiguoxiao", sect: 'taichung' },
            { id: "tmrt_106", StationID: ["G6"], name: "文心崇德", estring: "wenxinchongde", sect: 'taichung' },
            { id: "tmrt_107", StationID: ["G7"], name: "文心中清", estring: "wenxinzhongqing", sect: 'taichung' },
            { id: "tmrt_108", StationID: ["G8"], name: "文華高中", estring: "wenhuaseniorhighschoolwenhuagaozhong", sect: 'taichung' },
            { id: "tmrt_109", StationID: ["G8a"], name: "文心櫻花", estring: "wenxinyinghua", sect: 'taichung' },
            { id: "tmrt_110", StationID: ["G9"], name: "市政府", estring: "taichungcityhallshizhengfu", sect: 'taichung' },
            { id: "tmrt_111", StationID: ["G10"], name: "水安宮", estring: "shuiantempleshuiangong", sect: 'taichung' },
            { id: "tmrt_112", StationID: ["G10a"], name: "文心森林公園", estring: "wenxinforestpark", sect: 'taichung' },
            { id: "tmrt_113", StationID: ["G11"], name: "南屯", estring: "nantun", sect: 'taichung' },
            { id: "tmrt_114", StationID: ["G12"], name: "豐樂公園", estring: "fengleparkfenglegongyuan", sect: 'taichung' },
            { id: "tmrt_115", StationID: ["G13"], name: "大慶", estring: "daqing", sect: 'taichung' },
            { id: "tmrt_116", StationID: ["G14"], name: "九張犁", estring: "jiuzhangli", sect: 'taichung' },
            { id: "tmrt_117", StationID: ["G15"], name: "九德", estring: "jiude", sect: 'taichung' },
            { id: "tmrt_118", StationID: ["G16"], name: "烏日", estring: "wuri", sect: 'taichung' },
            { id: "tmrt_119", StationID: ["G17"], name: "高鐵臺中站", estring: "hSRtaichungstationgaotietaizhongzhan", sect: 'taichung' }
        ],
        line: [
            {
                id: "tmrt_g",
    ...
    klrt: {
        ...
        station_ary: [
            //Circular Light Rail
            { id: "klrt_c1", StationID: ["C1"], name: "籬仔內", estring: "lizihnei", sect: "kaohsiung" },
            { id: "klrt_c2", StationID: ["C2"], name: "凱旋瑞田", estring: "kaisyuanrueitian", sect: "kaohsiung" },
            { id: "klrt_c3", StationID: ["C3"], name: "前鎮之星", estring: "cianjhenstar", sect: "kaohsiung" },
            { id: "klrt_c4", StationID: ["C4"], name: "凱旋中華", estring: "kaisyuanjhonghua", sect: "kaohsiung" },
            { id: "klrt_c5", StationID: ["C5"], name: "夢時代", estring: "dreammall", sect: "kaohsiung" },
            { id: "klrt_c6", StationID: ["C6"], name: "經貿園區", estring: "commerceandtradepark", sect: "kaohsiung" },
            { id: "klrt_c7", StationID: ["C7"], name: "軟體園區", estring: "softwaretechnologypark", sect: "kaohsiung" },
            { id: "klrt_c8", StationID: ["C8"], name: "高雄展覽館", estring: "kaohsiungexhibitioncenter", sect: "kaohsiung" },
            { id: "klrt_c9", StationID: ["C9"], name: "旅運中心", estring: "cruiseterminal", sect: "kaohsiung" },
            { id: "klrt_c10", StationID: ["C10"], name: "光榮碼頭", estring: "glorypier", sect: "kaohsiung" },
            { id: "klrt_c11", StationID: ["C11"], name: "真愛碼頭", estring: "lovepier", sect: "kaohsiung" },
            { id: "klrt_c12", StationID: ["C12"], name: "駁二大義", estring: "dayipier2", sect: "kaohsiung" },
            { id: "klrt_c13", StationID: ["C13"], name: "駁二蓬萊", estring: "penglaipier2", sect: "kaohsiung" },
            { id: "klrt_c14", StationID: ["C14"], name: "哈瑪星", estring: "hamasen", sect: "kaohsiung" },
            { id: "klrt_c15", StationID: ["C15"], name: "壽山公園站", estring: "shoushanpark", sect: "kaohsiung" },
            { id: "klrt_c16", StationID: ["C16"], name: "文武聖殿站", estring: "wenwutemple", sect: "kaohsiung" },
            { id: "klrt_c17", StationID: ["C17"], name: "鼓山區公所站", estring: "gushandistrictoffice", sect: "kaohsiung" },
            { id: "klrt_c18", StationID: ["C18"], name: "鼓山", estring: "gushan", sect: "kaohsiung" },
            { id: "klrt_c19", StationID: ["C19"], name: "馬卡道", estring: "makadao", sect: "kaohsiung" },
            { id: "klrt_c20", StationID: ["C20"], name: "臺鐵美術館", estring: "tramuseumoffinearts", sect: "kaohsiung" },
            { id: "klrt_c21a", StationID: ["C21A"], name: "內惟藝術中心", estring: "neiweiartscenter", sect: "kaohsiung" },
            { id: "klrt_c21", StationID: ["C21"], name: "美術館", estring: "kaohsiungmuseumoffinearts", sect: "kaohsiung" },
            { id: "klrt_c22", StationID: ["C22"], name: "聯合醫院", estring: "kaohsiungmunicipalunitedhospital", sect: "kaohsiung" },
            { id: "klrt_c23", StationID: ["C23"], name: "龍華國小", estring: "longhuaelementaryschool", sect: "kaohsiung" },
            { id: "klrt_c24", StationID: ["C24"], name: "愛河之心", estring: "heartofloveriver", sect: "kaohsiung" },
            { id: "klrt_c25", StationID: ["C25"], name: "新上國小", estring: "sinshangelementaryschool", sect: "kaohsiung" },
            { id: "klrt_c26", StationID: ["C26"], name: "大順民族", estring: "dashunminzu", sect: "kaohsiung" },
            { id: "klrt_c27", StationID: ["C27"], name: "灣仔內(大順鼎山)", estring: "wanzihneidashundingshan", sect: "kaohsiung" },
            { id: "klrt_c28", StationID: ["C28"], name: "高雄高工", estring: "kaohsiungindustrialhighschool", sect: "kaohsiung" },
            { id: "klrt_c29", StationID: ["C29"], name: "樹德家商", estring: "shutehomeeconomicscommercialhighschool", sect: "kaohsiung" },
            { id: "klrt_c30", StationID: ["C30"], name: "科工館", estring: "scienceandtechnologymuseum", sect: "kaohsiung" },
            { id: "klrt_c31", StationID: ["C31"], name: "聖功醫院", estring: "stjosephhospital", sect: "kaohsiung" },
            { id: "klrt_c32", StationID: ["C32"], name: "凱旋公園站", estring: "kaisyuanpark", sect: "kaohsiung" },
            { id: "klrt_c33", StationID: ["C33"], name: "衛生局站", estring: "departmentofhealth", sect: "kaohsiung" },
            { id: "klrt_c34", StationID: ["C34"], name: "五權國小站", estring: "wucyuanelementaryschool", sect: "kaohsiung" },
            { id: "klrt_c35", StationID: ["C35"], name: "凱旋武昌站", estring: "kaisyuanwuchang", sect: "kaohsiung" },
            { id: "klrt_c36", StationID: ["C36"], name: "凱旋二聖站", estring: "kaisyuanersheng", sect: "kaohsiung" },
            { id: "klrt_c37", StationID: ["C37"], name: "輕軌機廠站", estring: "lrtdepot", sect: "kaohsiung" }
        ],
        line: [
            {
                id: "klrt_c",
                ...
                station: [
                    ...
                    "C21A", "C21", "C22", "C23", "C24", "C25", "C26", "C27", "C28", "C29",
    ...
    tra: {
        ...
        station_ary: [//big: e for big station of east(dongbu), w for big station of west(xibu), s for south link(nanhuei)
            ...
            { id: "tra_1075", v3id: "1075", name: "鳳鳴", estring: "fengming", sect: "taipei" },
    ...
    transStation: [
        {
            ...
            video: {
                ...
                "tymc_a01": { width: 420, height: 315, src: 'https://www.youtube.com/embed/ulOu7N85QRo' }
            },
            walkMinute: 7
        }, {
            ...
            video: {
                ...
                "tymc_a01": { width: 420, height: 315, src: 'https://www.youtube.com/embed/A6PPO4zqxJI' }
            },
            walkMinute: 12
        }, {
            ...
            video: {
                ...
                "tymc_a01": { width: 420, height: 315, src: 'https://www.youtube.com/embed/uaLbpXkDiX4' }
            },
            walkMinute: 11
        }, {
            ...
            video: {
                ...
                "tymc_a01": { width: 420, height: 315, src: 'https://www.youtube.com/embed/g5nm5Sbn6bw' }
            },
            walkMinute: 11
        }, {
    ...
    routeSystem: [
        {
            ...
            rType: 'cross',//direct , trans 
            company: ['tymc', 'tra'],// cross company serial
